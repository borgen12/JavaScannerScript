...
{	
	...
	IFRA2_36_2018,  // 2 x 36 french id (2018 new version)
	...
	VKEN2_44,  // kenyan visa
	PNRUS2_44,  // Russian PN (Passport National)
	...
	MBUL3_30,  // Bulgarian Motor Vehicle Registration 3 x 30
	...
	IURY3_30, // Uruguay 3 of 30 can have both O and 0 in doc number, so cannot force O to 0
	IDL1_30,   // ISO 18013 Driver's License
	DLNLD1_30, // Dutch Driver's License
	DLFRA1_30, // French Driver's License
	RIC1_18,   // Chinese Resident Identity Card
	PK1_10,	// Custom 1 line of 10 (ANNNNNNN<N) from a Kazakstan passport (ex N1462421<7)
	SPA1_8,     // 1 x 8 spanish id front id
	CHID3_30,  // China Identity Card
